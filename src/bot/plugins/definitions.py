...
PluginManifest = list[dict[str, str]]
...
_PLUGIN_DEFINITIONS: PluginManifest = [
    ...
    {"name": "bio_bait_spam", "handler_group": "1", "description": "Detect and alert on bio bait patterns"},
...
def get_plugin_definitions() -> PluginManifest:
    """Return a copy of all built-in plugin definitions.

    Returns:
        List of plugin descriptor dicts with keys: name, handler_group, description.
    """
    return list(_PLUGIN_DEFINITIONS)