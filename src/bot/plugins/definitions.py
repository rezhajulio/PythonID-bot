...
_PLUGIN_DEFINITIONS: PluginManifest = [
    ...
    {"name": "check_group_callback", "handler_group": 0, "description": "Group selector callback for /check"},
    {"name": "verify_callback", "handler_group": 0, "description": "Admin verify (photo exemption) button callback"},
