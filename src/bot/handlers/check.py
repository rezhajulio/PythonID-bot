...
async def handle_check_command(
    ...
    try:
        ...
        await update.message.reply_text("❌ Gagal memeriksa user.")
...
async def handle_check_group_callback(
    ...
    try:
        ...
        await query.edit_message_text("❌ Gagal memeriksa user.")
...
async def handle_warn_callback(
    ...
    try:
        ...
        await query.edit_message_text("❌ Gagal mengirim peringatan.")
